...
//
//    }
    public int RegisterInfo(Registration new_entry) throws NullPointerException, SQLException, MessagingException, UnsupportedEncodingException
    {
//    try {
        String uuid = UUID.randomUUID().toString();
        String query1 = "INSERT INTO registration_info(first_name,last_name,email,contact_number,garage_number,vehicle_number,id)VALUES(?,?,?,?,?,?,?)";
...
//    }
    ...
    public int ParkingInfo(parking new_status) throws NullPointerException, SQLException, MessagingException, UnsupportedEncodingException {
